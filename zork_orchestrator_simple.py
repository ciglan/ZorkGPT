...
class ZorkSimpleOrchestrator:
    ...
    def play_episode(self, zork_interface_instance) -> int:
        ...
        current_game_state, current_zork_score_val, max_zork_score, current_inventory = (
        ...
        while (
            ...
            self._check_objective_completion(agent_action, next_game_state, llm_extracted_info)
    ...
    def _initialize_episode(self, zork_interface_instance) -> Tuple[str, int, int, List[Any]]:
        ...
        self.export_current_state()
        return current_game_state, current_zork_score_val, max_zork_score, current_inventory
    ...
    def _pre_turn_inventory_and_combat(
        ...
        if not in_combat:
            ...
            if inventory_response:
                ...
                if game_over_flag:
                    ...
                    self.export_current_state()
                    return True, current_zork_score_val, max_zork_score, current_inventory, in_combat
        else:
            self.logger.info(
        ...
        return False, current_zork_score_val, max_zork_score, current_inventory, in_combat
    ...
    ) -> Tuple[str, str, float, str, bool, float, Optional[List[Dict[str, Any]]]]:
        ...
        for _ in range(max_rejections):
            ...
            override_needed, override_reason = (
                self.critic.rejection_system.should_override_rejection(
                    ...
                    self.failed_actions_by_location,
                    {
                        "turns_since_movement": getattr(self, "turns_since_movement", 0),
                        ...
                        "recent_actions": [action for action, _ in self.action_history[-8:]],
    ...
    def _execute_and_process_action(
        ...
        was_overridden: bool,
        rejected_actions_with_justifications: Optional[List[Dict[str, Any]]],
    ) -> Tuple[bool, str, int, int, str, Optional[ExtractorResponse]]:
        ...
        try:
            ...
            if game_over_flag:
                ...
                self.export_current_state()
                return True, next_game_state, current_zork_score_val, max_zork_score, self.current_room_name_for_map, llm_extracted_info if 'llm_extracted_info' in locals() else None
            ...
            current_location_id = self.game_map._create_unique_location_id(
                ...
                description=" ".join(llm_extracted_info.important_messages)
                if llm_extracted_info
                else "",
            ...
            return True, "Game ended unexpectedly", self.previous_zork_score, 585, self.current_room_name_for_map, None
