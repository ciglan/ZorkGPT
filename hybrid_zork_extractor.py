    ...
    def _extract_structured_info(self, game_text_from_zork: str) -> dict:
        ...
        return {
            "current_location_name": (
                self.structured_parser.get_canonical_room_name(
            ...
            "important_messages": (
                [structured_result.game_text] if structured_result.game_text else []
            ),
