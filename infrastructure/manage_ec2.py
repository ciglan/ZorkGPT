...
def get_stack_output(output_key: str) -> str | None:
...
def update_zorkgpt():
    ...
    try:
        ...
        print(f"❌ Update script execution failed: {e}")
        print("💡 You may want to check the service status or logs for more details")
